...
<div class="tile is-child is-12 box"  transition:fly="{{x: 200, duration: 900, delay: 600}}">
    <p class="title">Programming Skills</p>
    {#each programmingSkills as singleSkill }
        <span class="is-clearfix">{singleSkill.tech}</span>
